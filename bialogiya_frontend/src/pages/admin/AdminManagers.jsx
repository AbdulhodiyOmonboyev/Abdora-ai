...
import { Plus, Copy, X, User, Phone, MapPin, Trash2 } from 'lucide-react';
      ...
      <div className="space-y-3">
        {managers.map((manager, index) => (
          <motion.div key={manager.id} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: index * 0.03 }}
            className="card flex items-center gap-3 cursor-pointer hover:shadow-lg transition-shadow" onClick={() => navigate(`/admin/managers/${manager.id}`)}>
