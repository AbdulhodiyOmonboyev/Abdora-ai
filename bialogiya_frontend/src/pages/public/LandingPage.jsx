...
export default function LandingPage() {
  return <main>
    ...
    <section className="home-stats-grid public-container">{stats.map(([value, label, Icon]) => <div className="public-card home-stat-card" key={label}><Icon size={19} /><strong>{value}</strong><span>{label}</span></div>)}</section>
