      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
          <div className="bg-slate-50 dark:bg-slate-900/30 rounded-lg p-4">
            <div className="text-sm dark:text-slate-500 mb-2">Jami guruh</div>
            <div className="text-2xl font-semibold dark:text-slate-900 dark:text-white">{branch.groups?.length || 0}</div>
          </div>
          <div className="bg-slate-50 dark:bg-slate-900/30 rounded-lg p-4">
            <div className="text-sm dark:text-slate-500 mb-2">Oylik taxminiy daromad</div>
            <div className="text-2xl font-semibold dark:text-slate-900 dark:text-white">
          ...
          <div className="bg-slate-50 dark:bg-slate-900/30 rounded-lg p-4">
            <div className="text-sm dark:text-slate-500 mb-2">Faol o'quvchilar</div>
            <div className="text-2xl font-semibold dark:text-slate-900 dark:text-white">{branch.studentsCount || 0}</div>
          </div>
        </div>
        ...
        <div className="space-y-3">
          {(branch.groups || []).map((group) => (
            <div key={group.id} className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 p-4 bg-white dark:bg-slate-950 rounded-2xl border border-slate-200 dark:border-slate-800">
              ...
              <div className="text-sm dark:text-slate-700 dark:text-slate-300">
