      ...
      {total > 0 && (
        <div className="flex gap-4 mb-6">
          <div className="card flex-1 text-center py-4">
            ...
            <div className="text-sm text-gray-500">Davomat foizi</div>
          </div>
          <div className="card flex-1 text-center py-4">
            <div className="text-3xl font-black text-green-500">{present}</div>
            <div className="text-sm text-gray-500">Kelgan</div>
          </div>
          <div className="card flex-1 text-center py-4">
      ...
      <div className="space-y-2">
          ...
          return (
            <motion.div key={i} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: i * 0.03 }}
              ...
              <div className="flex-1">
                <div className="font-medium text-sm text-gray-800 dark:text-white">Dars</div>
        ...
        {!isLoading && total === 0 && (
          <div className="text-center py-12 text-gray-400">
            ...
            <p>Hali davomat yozuvlari yo'q</p>
          </div>
        )}
      </div>
    </div>
