...
export default function StudentAnalytics() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <h1 className="text-2xl font-bold text-gray-800 dark:text-white">Mening tahlillarim</h1>
      ...
      <div className="card">
        ...
        {chartData.length > 0 ? (
          ...
          <div className="h-40 flex items-center justify-center text-gray-400 text-sm">Ballar tarixini ko'rish uchun testlarni yeching</div>
        )}
      </div>
