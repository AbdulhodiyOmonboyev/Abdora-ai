...
export default function StudentLessons() {
  ...
  if (!user?.groupId) return (
    <div className="text-center py-20">
      ...
      <h2 className="text-xl font-bold text-gray-500">Guruh biriktirilmagan</h2>
      <p className="text-gray-400 mt-1">O'qituvchingizdan sizni guruhga qo'shishni so'rang.</p>
    </div>
  );
