    ...
    <div className="max-w-4xl mx-auto">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">Test natijalari tahlili</p>
        </div>
      </div>
      ...
      {chartData.length > 0 && (
        <div className="card mb-6">
          <h3 className="font-bold text-gray-800 dark:text-white mb-4 flex items-center gap-2"><BarChart2 size={16} className="text-primary" /> Ballar taqsimoti</h3>
