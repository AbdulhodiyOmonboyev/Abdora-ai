...
export const themePresets = [
  ...
  createTheme({
    ...
    values: {
      background: '#080D17',
      secondaryBackground: '#141E2D',
      cardBackground: '#101827',
      surfaceColor: '#141E2D',
      primaryColor: '#FF6A00',
      secondaryColor: '#4D8DFF',
      accentColor: '#9A72FF',
      buttonColor: '#FF6A00',
      buttonHover: '#FF8133',
      buttonText: '#FFFFFF',
      ...
      borderColor: '#223047',
      dividerColor: '#1E2D42',
      inputBackground: '#0B111D',
      inputBorder: '#2C3E54',
      navbarBackground: '#0B111D',
      sidebarBackground: '#0B111D',
      footerBackground: '#080D17',
      successColor: '#25C58A',
      warningColor: '#F59E0B',
      errorColor: '#FF5C68',
      infoColor: '#4D8DFF',
